        ...
        return (
            <>
                ...
                <div className={this.props.animation}>
                    ...
                    <Project title="GeoGuessr Clone" description={geoDesc} linkName="Currently Not Deployed" link="#" gif={geoVt} githubLink="https://github.com/BurlingtonCodeAcademy/geo-vermonter-pphelps28" />
                    ...
                    <Project title="First PHP" description={phpDesc} gif={phpBlog} githubLink="https://github.com/pphelps28/PHP_Blog" />
                    <Project title="Text Adventure" description={textAdventureDesc} gif={TextAdventure} githubLink="https://github.com/pphelps28/zorkington-pphelps28-1" />
                    <Project title="Guess The Number" description={guessDesc} gif={guess} githubLink="https://github.com/pphelps28/guess-the-number-pphelps28-1" />
                    <Project linkName={"Thanks for visiting 😊"} lastComponent={true} />
                </div>
            </>
        )
    }
